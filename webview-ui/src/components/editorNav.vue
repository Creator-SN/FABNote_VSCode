<template>
	...
	>
		...
		>
			<div class="fb-editor-nav-container">
				<div
...
defineExpose({
	getEditorNavList: (...args) => proxy.getEditorNavList(...args),
});
</script>
